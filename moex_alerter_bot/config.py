...
MOEX_BOARD_NAME = str(os.getenv('MOEX_BOARD_NAME', 'Т+: Акции и ДР - безадрес.'))
MOEX_ENGINES = str(os.getenv('MOEX_ENGINES', 'stock'))
MOEX_BOARD_ID = str(os.getenv('MOEX_BOARD_ID', 'TQBR'))
MOEX_MARKETS = str(os.getenv('MOEX_MARKETS', 'shares'))
LOGGER = get_logger()
